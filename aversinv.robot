...
Підготувати клієнт для користувача
  ...
  Run Keyword If   '${ARGUMENTS[0]}' != 'avirsinv_viewer'   Login   ${ARGUMENTS[0]}
...
Підготувати дані для оголошення тендера
  ...
  ${tender_data}=  Run Keyword If   '${username}' == 'avirsinv_owner'   
...
Оновити сторінку з тендером
    ...
    avirsinv.Пошук тендера по ідентифікатору    ${ARGUMENTS[0]}    ${ARGUMENTS[1]}
...
Створити тендер
  ...
  ...      ${ARGUMENTS[1]} ==  tender_data
    ...
    ${value_valueaddedtaxincluded}=              convert_avirsinv_string   ${value_valueaddedtaxincluded}
    ...
    ${auctionperiod_startdate}=                  avirsinv_convertdate  ${auctionperiod_startdate}
	${dgfDecisionDate}=                          avirsinv_convertdate  ${dgfDecisionDate}
...
Додати предмет закупівлі
  ...
  avirsinv.Пошук тендера по ідентифікатору   ${username}   ${tender_uaid}
...
Отримати документ
    ...
    avirsinv_download_file   ${url}  ${file_name}  ${OUTPUT_DIR}
    [return]  ${file_name}
...
Отримати інформацію із тендера
    ...
    ...  Run Keywords
    ...  avirsinv.Оновити сторінку з тендером   ${username}   ${tender_uaid}
    ...  AND
    ...  ${return_value}=   avirsinv.Отримати інформацію із тендера  ${username}  ${tender_uaid}  ${field_name}
    ...  ELSE   Set Variable   ${return_value}
    [Return]  ${return_value}
...
Отримати інформацію із предмету
  ...
  ${field_path}=   avirsinv_replace  ${locator.items.${field_name}}  ${text_to_replace}  ${field_namefull}
...
Отримати інформацію про status
  ...
  ${return_value}=   convert_avirsinv_string     ${return_value}
  [Return]  ${return_value}
...
Отримати інформацію про value.amount
  ...
  ${return_value}=   avirsinv_convert_usnumber   ${return_value}
...
Отримати інформацію про dgfDecisionDate
  ...
  ${return_value}=   convert_avirsinv_sdate_to_iso_sdate_format   ${return_value}
  [Return]  ${return_value}
...
Отримати інформацію про tenderPeriod.startDate
  ...
  ${return_value}=   convert_avirsinv_date_to_iso_format   ${return_value}
...
Змінити цінову пропозицію
	...
	${resp}=            avirsinv_convert_usnumber      ${resp}
...
Скасувати цінову пропозицію
  [Arguments]  ${username}  ${tender_uaid}
  avirsinv.Отримати пропозицію  ${username}  ${tender_uaid}
...
Отримати інформацію із пропозиції
  ...
  ${bid}=   avirsinv.Отримати пропозицію  ${username}  ${tender_uaid}
...
Завантажити фінансову ліцензію
  ...
  avirsinv.Завантажити документ в ставку  ${username}  ${filepath}  ${tender_uaid}  financialLicense
...
Завантажити документ
    ...
    avirsinv.Завантажити документ в тендер з типом  ${username}  ${tender_uaid}  ${filepath}  tenderNotice

#SV
Завантажити ілюстрацію
    [Arguments]  ${username}  ${tender_uaid}  ${filepath}
	avirsinv.Завантажити документ в тендер з типом  ${username}  ${tender_uaid}  ${filepath}  illustration
...
Задати запитання на тендер
  ...
  avirsinv.Задати питання  ${username}  ${tender_uaid}  ${question}  ${btnlocator}
...
Отримати інформацію про questions[${q_id}].${field_name}
  ...
  ${return_value}=   Run Keyword If   "${field_name}" == "date"   avirsinv_convertdate   ${return_value}
  ...   ELSE   Set Variable   ${return_value}
  [Return]  ${return_value}
...
Скасування рішення кваліфікаційної комісії
	...
	...  avirsinv.Скасування рішення кваліфікаційної комісії учасником  ${username}  ${tender_uaid}  ${award_num}
	...  ELSE  avirsinv.Скасування рішення кваліфікаційної комісії замовником  ${username}  ${tender_uaid}  ${award_num}
...
Отримати посилання на аукціон для учасника
    ...
    ...   sleep   102
    ...   AND   avirsinv.Отримати пропозицію   ${username}   ${tender_uaid}
...
Підтвердити підписання контракту
	...
	${contractSigndate}=		avirsinv_convertdate						${contractSigndate}
